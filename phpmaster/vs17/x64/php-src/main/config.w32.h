...
#define PHP_BUILD_SYSTEM "Microsoft Windows 10 Pro for Workstations [10.0.19045]"

/* Configure line */
#define CONFIGURE_COMMAND "cscript /nologo /e:jscript configure.js  \"--with-pgo\" \"--enable-debug-pack\"" " \"--with-extra-includes\" \"--with-extra-libs\" \"--enable-apache2handler\"" " \"--with-bz2\" \"--enable-sockets\" \"--enable-shmop\" \"--with-snmp\"" " \"--with-sodium\" \"--with-sqlite3\" \"--with-password-argon2\" \"--enable-mbstring\"" " \"--enable-mbregex\" \"--with-pspell\" \"--with-sodium\" \"--with-sqlite3\"" " \"--with-password-argon2\" \"--enable-zend-test\" \"--enable-exif\"" " \"--enable-pdo\" \"--with-pdo-sqlite\" \"--with-openssl\" \"--enable-phar-native-ssl\"" " \"--enable-soap\" \"--with-all-shared\" \"--enable-cli\" \"--enable-cgi\"" " \"--enable-snapshot-build\""

/* Detected compiler version */
#define PHP_BUILD_COMPILER "MSVC 19.32.31333, untested"

/* Compiler compatibility ID */
#define PHP_COMPILER_ID "19.32.31333"
